...
export function InvertersComparisonChart({ analytics }: InvertersComparisonChartProps) {
    ...
    return (
        <div className="col-span-full rounded-2xl border bg-card p-4">
            <div className="mb-4">
                <h2 className="font-display text-lg font-semibold text-foreground">Comparação entre Inversores</h2>
                <p className="text-sm text-muted-foreground">Performance comparativa de energia e potência</p>
            </div>
            {chartData.length === 0 ? (
