...
const uploadClientBill = async (request: NextRequest) => {
    ...
    const billData = {
        ...
        aiExplanations: (analysis.aiExplanations ?? Prisma.JsonNull) as any,
        aiRecommendations: (analysis.aiRecommendations ?? Prisma.JsonNull) as any,
        alerts: (analysis.alerts ?? Prisma.JsonNull) as any,
        extraCharges: jsonColumns.extraCharges as any,
        billingItems: jsonColumns.billingItems as any,
        creditSummary: jsonColumns.creditSummary as any,
